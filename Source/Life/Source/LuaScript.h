...
public:
	...
	// Return for unable to find variable
	template<typename T>
	T lua_getdefault()
	{
		return 0;
...
// If lua_get is bool: return boolean
template <>
...
// If lua_get is float: return float
template <>
...
// If lua_get is string: return string
template <>
...
// Return for unable to find variable (in case the variable is a string)
template<>
